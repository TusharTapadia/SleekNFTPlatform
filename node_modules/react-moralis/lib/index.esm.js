...
var defaultUseResolveCallOptions = {
    autoFetch: true,
};
var _useResolveCall = function (call, initialData, params, options) {
    var isInitialized = useMoralis().isInitialized;
    var autoFetch = __assign(__assign({}, defaultUseResolveCallOptions), (options !== null && options !== void 0 ? options : {})).autoFetch;
...
var _useMoralisAuth = function (options) {
    ...
    var authenticate = useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, throwOnError = _b.throwOnError, type = _b.type, provider = _b.provider;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.authenticate(__assign(__assign({}, (!!type && { type: type })), (!!provider && { provider: provider })))];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
...
var _useMoralisWeb3 = function (isAuthenticated) {
    ...
    var enableWeb3 = useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, throwOnError = _b.throwOnError, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, provider = _b.provider;
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.enable(provider ? { provider: provider } : undefined)];
                    case 2:
                        currentWeb3 = _c.sent();
                        setWeb3(currentWeb3);
...
export { ByMoralis, MoralisContext, MoralisProvider, NoMoralisContextProviderError, NotAuthenticatedError, ReactMoralisError, ValidationError, useMoralis, useMoralisCloudFunction, useMoralisFile, useMoralisQuery, useMoralisSubscription, useMoralisWeb3Api, useMoralisWeb3ApiCall, useNewMoralisObject };
