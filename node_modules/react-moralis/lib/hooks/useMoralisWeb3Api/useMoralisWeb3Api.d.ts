...
import { ResolveCallParams, UseResolveCallOptions } from "../_useResolveAsyncCall";
export interface UseMoralisWeb3ApiCallOptions extends UseResolveCallOptions {
}
export declare const useMoralisWeb3ApiCall: <Params extends ResolveCallParams, Result extends unknown>(call: (params: Params) => Promise<Result>, params?: Params | undefined, options?: UseMoralisWeb3ApiCallOptions | undefined) => {
    ...
    error: Error | null;
    data: Result | null;
    setData: (f: Result | ((draft: Result | import("immer").Draft<Result> | null) => void) | null) => void;
};
export declare const useMoralisWeb3Api: () => {
    ...
    account: {
        ...
        getHistoricalNFTTransfers: (options: {
            chain?: "eth" | "0x1" | "ropsten" | "0x3" | "rinkeby" | "0x4" | "goerli" | "0x5" | "kovan" | "0x2a" | "polygon" | "0x89" | "mumbai" | "0x13881" | "bsc" | "0x38" | "bsc testnet" | "0x61" | "localdevchain" | "dev" | undefined;
            subdomain?: string | undefined;
            providerUrl?: string | undefined;
            from_block?: number | undefined;
