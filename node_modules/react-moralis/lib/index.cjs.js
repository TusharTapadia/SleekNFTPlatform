...
var useMoralisCloudFunction = function (name, params, options) {
    var call = react$1.useCallback(function (callParams) {
        return moralis.Moralis.Cloud.run(name, callParams);
    }, [name]);
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.Web3.authenticate(__assign(__assign({}, (!!type && { type: type })), (!!provider && { provider: provider })))];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.Web3.enable(provider ? { provider: provider } : undefined)];
                    case 2:
                        currentWeb3 = _c.sent();
                        setWeb3(currentWeb3);
...
var useMoralisWeb3Api = function () {
    return __assign({ Web3API: moralis.Moralis.Web3API }, moralis.Moralis.Web3API);
};
